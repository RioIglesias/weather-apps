  ...
  Widget build(BuildContext context) {
    return DraggableScrollableSheet(
      ...
      builder: (context, scrollController) {
        return ClipRRect(
          borderRadius: SizeCustomize.borderRadiusCircular(
            top: 50,
          ),
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Color(0xFF2E335A).withValues(alpha: 0.40),
                    Color(0xFF1C1B33).withValues(alpha: 0.94),
                  ],
                ),
              ),
              child: Stack(
                            ...
                            child: GridView(
                              ...
                              children: [
                                CustomizeCard(
                                  ...
                                  title: "FEELS LIKE",
                                  text:
                                      "Similiar to the actual temperature",
                                  value:
